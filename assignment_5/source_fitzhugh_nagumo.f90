program fitzhugh_nagumo_source
    implicit none
    ...
    do iter = 1, niter
        ...
        ! adding a small source term of activator
        ...
        if (iter == next_save) then
            ...
            ! for delayed source term, uncomment the next line
            ! a(int(nx/2),int(ny/2)) = a(int(nx/2),int(ny/2)) + 0.1
        end if
...
end program fitzhugh_nagumo_source
