...
integral_vals = np.loadtxt("/home/riddhiman/computational_physics/assignment_2/brute_force_integral_new_bound.txt", usecols=0)
...
plt.title("Distribution of Integral Values by Brute Force, Bound from -8 to 8")
...
plt.savefig('/home/riddhiman/computational_physics/assignment_2/images_assignment2/brute_force_value_new_bound.png')
plt.show()