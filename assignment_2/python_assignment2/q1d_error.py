...
n, error = np.loadtxt("/home/riddhiman/computational_physics/assignment_2/error_vs_n_gaussian.txt", unpack=True)
...
plt.ylabel('Error')
plt.title('Log-Log Plot of Error vs n, Gaussian integral')

# Show the plot with a legend
plt.legend()
plt.grid(True)
plt.savefig('/home/riddhiman/computational_physics/assignment_2/images_assignment2/error_vs_n_loglog_erf.png')
plt.show()
