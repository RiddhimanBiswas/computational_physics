...
plt.title('Scatter Plot of Random Numbers, Gaussian distribution')
plt.xlabel('Index')
...
plt.grid(True)
plt.legend()
plt.savefig('/home/riddhiman/computational_physics/assignment_2/images_assignment2/gaussian_random_scatter.png')
plt.show()