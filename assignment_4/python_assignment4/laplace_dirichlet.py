...
data = np.loadtxt('/home/riddhiman/computational_physics/assignment_4/laplace_dirichlet.txt')
...
print(f"Temperature at (20, 20): {T[19, 19]}")
...
plt.title('Temperature Profile, Dirichlet Boundary Conditions')
plt.show()
