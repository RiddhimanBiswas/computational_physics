...
data = np.loadtxt('/home/riddhiman/computational_physics/assignment_1/random_walk_bin_data_10.txt')
...
plt.title('10000 random walk, 10000 steps, bin size = 10')  # Customize title
plt.xlabel('Sum')
plt.ylabel('Count')
plt.legend()
plt.grid(True)
plt.xlim(-1000, 1000)  # Set x-axis limits
plt.savefig("q1j10_a.png")
plt.show()
