...
data = np.loadtxt('/home/riddhiman/computational_physics/assignment_1/histogram_data_bin_0.5.txt')
...
plt.title('Distribution of sum of 10000 random numbers, bin size = 0.5')  # Customize title
plt.xlabel('Sum')
plt.ylabel('Count')
plt.legend()
plt.grid(True)
plt.xlim(4500, 5500)  # Set x-axis limits
plt.savefig("q1h0.5_a.png")
plt.show()
